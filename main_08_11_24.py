...
def get_example_objects(n: int) -> pd.DataFrame:                                                     ### Ma fonction
    ...
    Returns:
        pd.DataFrame: A DataFrame containing up to `n` randomly sampled rows from example-objects.json.
    """
    # Load the JSON file into a DataFrame
    df = pd.read_json("all_adresses_objets.json", orient="records")                                   ######## all_adresses_objets.json ou example-objects.json, à changer 
...
def render_objects(
    ...
    render_dir: str = "render_outputs",                                                                #### Nom du dossier
